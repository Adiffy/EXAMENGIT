Proceso ProgramaGIT
	...
	Definir numalumno Como Entero; //n� de alumnos 
	
	Escribir " �Cu�ntos alumnos hay en la clase?";
	leer numalumno;
  ...
  Para i<-0 hasta numalumno-1 Hacer//La terminacion en 10 es un error claramente 
	...
	//Ahora el programa puede ejecutarse con el n�mero de alumnos definido por el usuario
